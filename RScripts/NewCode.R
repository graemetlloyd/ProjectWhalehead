...
for(i in RevBayesFiles) {
  ...
  pdf(paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/Boxplots/SCI/", gsub(".nex.trees", "", i), ".pdf", sep = ""))
  boxplot(SCIList, ylab = "Stratigraphic Consistency Index")
  dev.off()
  pdf(paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/Boxplots/RCI/", gsub(".nex.trees", "", i), ".pdf", sep = ""))
  boxplot(RCIList, ylab = "Relative Completeness Index")
  dev.off()
  pdf(paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/Boxplots/MSMStar/", gsub(".nex.trees", "", i), ".pdf", sep = ""))
  boxplot(MSMStarList, ylab = "Manhattan Stratigraphic Measure*")
  dev.off()
  pdf(paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/Boxplots/GER/", gsub(".nex.trees", "", i), ".pdf", sep = ""))
  boxplot(GERList, ylab = "Gap Excess Ratio (GER)")
  dev.off()
  pdf(paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/Boxplots/GERStar/", gsub(".nex.trees", "", i), ".pdf", sep = ""))
  boxplot(GERStarList, ylab = "Gap Excess Ratio (GER*)")
  dev.off()
  pdf(paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/Boxplots/GERt/", gsub(".nex.trees", "", i), ".pdf", sep = ""))
  boxplot(GERtList, ylab = "Gap Excess Ratio (GERt)")
  dev.off()
  pdf(paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/Boxplots/MIG/", gsub(".nex.trees", "", i), ".pdf", sep = ""))
  boxplot(MIGList, ylab = "Minimum Implied Gap")
  dev.off()
  
  # Write out results tables:
  write.table(cbind(StratPhyloCongruenceResults$input.tree.results, Bayes = c(rep(1, length(BayesianTrees)), rep(0, length(ParsimonyTrees)))), paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/StratCongruenceResults/InputTreeResults/", gsub(".nex.trees", "", i), ".txt", sep = ""))
  write.table(StratPhyloCongruenceResults$rand.permutations, paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/StratCongruenceResults/RandomTreeResults/", gsub(".nex.trees", "", i), ".txt", sep = ""))
  
  # Write out trees:
  ape::write.tree(StratPhyloCongruenceResults$input.trees[1:length(BayesianTrees)], paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/StratCongruenceResults/TimeScaledTrees/BayesianTrees/", gsub(".nex.trees", "", i), ".tre", sep = ""))
  ape::write.tree(StratPhyloCongruenceResults$input.trees[(length(BayesianTrees) + 1):(length(BayesianTrees) + length(ParsimonyTrees))], paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/StratCongruenceResults/TimeScaledTrees/ParsimonyTrees/", gsub(".nex.trees", "", i), ".tre", sep = ""))
  ape::write.tree(StratPhyloCongruenceResults$rand.trees, paste("~/Documents/Publications/in prep/Strat congruence - April/ProjectWhalehead/Data/StratCongruenceResults/TimeScaledTrees/RandomTrees/", gsub(".nex.trees", "", i), ".tre", sep = ""))
